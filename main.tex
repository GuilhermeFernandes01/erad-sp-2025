...
Este artigo explorou a migração de VMs em \textit{data centers} e evidenciou como o CloudSim Plus pode auxiliar na comparação de políticas de migração. Mostrou-se que a mesma infraestrutura pode adotar diversas estratégias, permitindo avaliar com precisão qual abordagem melhor atende a objetivos como a eficiência energética.

A implementação de métricas de emissão de gases de efeito estufa no CloudSim Plus representa um passo relevante para trabalhos futuros, ao possibilitar a avaliação do impacto de diferentes técnicas de migração e escalonamento em infraestruturas de larga escala. Os resultados dessas simulações devem fornecer subsídios concretos para projetistas e operadores de \textit{data centers}, incentivando práticas mais sustentáveis.

Embora o CloudSim Plus ofereça recursos valiosos para entender a dinâmica de infraestruturas de computação distribuída, sua neutralidade em termos de sustentabilidade implica que a redução do consumo energético dependa da definição de cenários e métricas específicas. Assim, a efetividade de qualquer estratégia de escalonamento ou migração estará condicionada tanto à qualidade dos experimentos quanto à relevância dos parâmetros adotados.

Ao comparar e refinar abordagens com foco em eficiência energética, torna-se possível promover práticas mais sustentáveis em \textit{data centers}. Espera-se, portanto, que o arcabouço construído e os experimentos futuros ampliem o conhecimento e a aplicação de técnicas que minimizem as emissões de gases de efeito estufa.
